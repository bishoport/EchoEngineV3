...
namespace libCore
{
    ...
    public:
        ...
        void updateMatrix();
        virtual void Inputs(libCore::Timestep deltaTime) = 0;
        ...
        Frustum GetFrustum() const { return frustum; } // Getter para el frustum
        bool IsBoxInFrustum(const glm::mat4& transform,const glm::vec3& min, const glm::vec3& max) const;
    private:
        Frustum frustum;
